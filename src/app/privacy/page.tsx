    ...
    <main className="bg-background min-h-screen text-foreground">
      ...
      <div className="pt-32 pb-24 px-4 max-w-4xl mx-auto">
        ...
        <div className="space-y-6 text-lg text-foreground/80 font-medium leading-relaxed">
          ...
          <p>
            We collect information you provide directly to us, such as your name, email address, and payment information when you register for an account or join our waitlist. We also collect usage data to help us improve our platform.
          </p>
