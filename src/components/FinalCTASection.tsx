...
const FinalCTASection = () => {
  ...
  return (
    <section className="py-12 sm:py-24 px-4 bg-background relative overflow-hidden">
      <div className="max-w-[1600px] mx-auto">
        <div className="anime-card p-8 sm:p-20 bg-secondary/10 border-dashed border-primary/40 flex flex-col items-center text-center gap-8 sm:gap-12 group transition-all duration-700">
           ...
           <p className="text-xl sm:text-2xl text-foreground/60 max-w-2xl font-medium italic animate-fade-in px-4">
           ...
           <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 text-foreground/40 font-bold uppercase tracking-widest text-xs sm:text-sm mt-4">
